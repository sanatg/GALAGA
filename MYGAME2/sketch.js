...
function preload(){
    ...
    startTextI = loadImage("./img/STARTER.png");
    playButtonI = loadImage("./img/PLAYBUTTON.png");
    chooseButtonI = loadImage("./img/chooseButto.png");
    backButton_img = loadImage("./img/back.png");
    shootButtonImg = loadImage("./img/SHOOT.png");
    buttonrightImg = loadImage("./img/RIGHT.png");
    buttonleftImg = loadImage("./img/LEFT.png");
    endingTextImg = loadImage("./img/OVER.png");
